...
namespace CankutayUcarCV.Business.Helpers.PasswordSecurity
{
    public static class PasswordSecurity
    {
        ...
        private const string SecurityKey = "D(G+KbPeShVmYp3s6v9y$B&E)H@McQfTjWnZr4t7w!z%C*F-JaNdRgUkXp2s5v8x";
